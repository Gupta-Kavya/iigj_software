...
<div id="page-wrapper"><div class="container-fluid rc-page">
    <div class="rc-head"><h1><i class="fa fa-sliders"></i> Rate Condition Master</h1><p>Create calculation rules by rate code and branch location.</p></div>
    ...
    <div class="rc-grid">
        <section class="rc-card">
            ...
            <div class="rc-body">
                <form method="post" id="condition_form">
                    ...
                    <div class="rc-row">
                        <div class="rc-field"><label>Rate Code *</label><input class="form-control" name="rate_code" id="rate_code" required></div>
        ...
        <section class="rc-card">
            ...
            <div class="rc-table-wrap"><table class="table table-hover rc-table"><thead><tr><th>Rate Code</th><th>Location</th><th>Rule</th><th>Value 1</th><th>Priority</th><th>Status</th><th>Notes</th><th></th></tr></thead><tbody>
                <?php foreach ($rules as $rule): ?><tr data-rule='<?php echo htmlspecialchars(json_encode($rule), ENT_QUOTES, 'UTF-8'); ?>'>
                    <td><strong><?php echo htmlspecialchars($rule['rate_code']); ?></strong></td>
