...
if (isset($_POST['croppedData'])) {
  ...
  if ($uploadToken !== '') {
    ...
    file_put_contents(atm_user_stone_dir() . "/$filename", $imageData);
  }
  echo "<img src = '" . atm_user_stone_relative($filename) . "?q=".time()."' style = 'width:100%; height:230px;' id = 'stone_image'>";
}
